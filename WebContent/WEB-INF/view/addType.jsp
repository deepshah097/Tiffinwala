    ...
    <div class="login-main">  
    	 ...
    	 <div class="login-head">
			...
			<div class="login-block">
				<form action="saveType.htm" method="post">
					Enter Type:
					<input type="text" name="type_name" required="required"></td>
                            ...
                            <div class="table-responsive">
                                <form action="saveType.htm" method="post">
								 <div class="form-group">
								    ...
								    <input type="text" name="type_name" class="form-control" required="required"></td>
