    ...
    <div class="login-main">  
    	 ...
    	 <div class="login-head">
			...
			<div class="login-block">
				<f:form action="updateType.htm"  modelAttribute="v1"  method="POST">
				<f:hidden path="type_id"/>						
					Type Name:
					<f:input path="type_name"/>
					<!-- <input type="text" name="city_name" required="required"></td>
					 -->
				...
				<!-- 			<ul>
					...
					<!-- <input type="submit" name="Sign In" value="Add"> -->
					<f:button style="width:100%;color:white;background:#337AB7;">Edit</f:button>	
                            ...
                            <div class="table-responsive">
								...
								<f:hidden path="type_id"/>
								 <div class="form-group">
								    ...
								    <f:input path="type_name" class="form-control"/>
								    <%-- <f:input path="city_name" class="form-control"/> --%>
								    <!-- <input type="text" class="form-control" value="jayjalaram@gmail.com" readonly="" /> -->
