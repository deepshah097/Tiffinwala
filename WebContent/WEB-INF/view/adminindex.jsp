							...
							<div class="profile_details_left"><!--notifications of menu start -->
								<ul class="nofitications-dropdown">
									<li class="dropdown head-dpdn">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><span class="badge blue">3</span><i class="fa fa-bell"></i></a>										
									</li>	
    ...
    <div class="sidebar-menu">
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-tachometer"></i><span>Active User</span></a></li>
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-tachometer"></i><span>Active Tiffinwala</span></a></li>
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-tachometer"></i><span>Pending Tiffinwala</span></a></li>
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-tachometer"></i><span>Disaproved Tiffinwala</span></a></li>
		      </ul>
		    </div>
	 </div>
	<div class="clearfix"> </div>
