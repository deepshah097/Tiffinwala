...
<div class="page-container">	
   <div class="left-content">
	   <div class="mother-grid-inner">
            <!--header start here-->
				<div class="header-main" style="background:#650101">
						 ...
						 <div class="header-right">
							<div class="profile_details_left"><!--notifications of menu start -->
								<ul class="nofitications-dropdown">
									<%-- <li class="dropdown head-dpdn"><span class="badge blue">${cnt}</span>
										<a href="Viewpendingtiffinwala.htm"><i class="fa fa-bell"></i></a>										
									</li> --%>	
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<div class="user-name">
													<p style="color:white"><%=uservo.getUser_name()%></p>
									...
									<li class="dropdown profile_details_drop">
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
											<div class="profile_img">	
												<div class="user-name">
													<p style="color:white"><%=uservo.getUser_name()%></p>
													<span style="color:white">Tiffinwala</span>
												</div>
											<!-- 	<i class="fa fa-angle-down lnr"></i>
												<i class="fa fa-angle-up lnr"></i>
											 -->	<div class="clearfix"></div>	
    ...
    <div class="sidebar-menu" style="background: #650101">
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-home"><a href="logout.htm"><i class="fa fa-sign-out"></i> Logout</a></li>
		      </ul>
		    </div>
	 </div>
	 <%}else { %>
	 <div class="sidebar-menu" style="background: #650101">
		    <div class="menu">
		      ...
		      <li id="menu-home" ><a href="Viewpendingorder.htm?id=<%=uservo.getUser_id() %>"><i class="fa fa-paper-plane"></i><span>View Panding orders</span></a></li>
		      <li id="menu-home" ><a href="changepassredirect.htm?id=<%=uservo.getUser_id() %>"><i class="fa fa-user"></i><span>Change Password</span></a></li>
		      <li id="menu-home"><a href="logout.htm"><i class="fa fa-sign-out"></i> Logout</a></li>
		      </ul>
		    </div>
	 </div>
